...
calcularPPeso (animal,peso) -> si calcula*/
    ...
    public void calcularPVariedad(List<? super Naranjas> lista, String variedad) {
        ...
        switch (variedad){
            case "Moro": System.out.println("El porcentaje naranjas de tipo Moro de es: " + ((cont / lista.size()) * 100) + "%"); 
            break;
            case "Sanguinello": System.out.println("El porcentaje naranjas de tipo Sanguinello de es: " + ((cont / lista.size()) * 100) + "%"); 
            break;
            case "Tarocco": System.out.println("El porcentaje naranjas de tipo Tarocco de es: " + ((cont / lista.size()) * 100) + "%"); 
            break;
            case "Navel": System.out.println("El porcentaje naranjas de tipo Navel de es: " + ((cont / lista.size()) * 100) + "%"); 
            break;
